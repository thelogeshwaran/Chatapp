...
function Searchbox() {
    ...
    useEffect(() => {
        ...
        {
            search ? setData(messages.filter((item) => item.data.message.message?.toUpperCase().includes(search.toUpperCase()))) : setData([]) 
        }
      },[search,messages]);
        ...
        <div className="searchbox">
           ...
           <div className="searchbox_container" >
                    ...
                    :
                     ...
                     <input className="search__input" type="text" value={search} autoFocus value={search} onChange={(e)=>setSearch(e.target.value)} placeholder="Search a chat" />
                </div>
           </div>
